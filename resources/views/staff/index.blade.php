            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        <a href="{{route('staff.trash')}}" class="btn btn-danger">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($data['rows'] as $i => $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('staff.show',$row->id)}}" class="btn btn-info">
                                        <i class="fa fa-eye" aria-hidden="true"></i> View</a>
                                    <a href="{{route('staff.edit',$row->id)}}" class="btn btn-warning">
                                        <i class="fas fa-edit" aria-hidden="true"></i> Edit</a>
                                    <form action="{{route('staff.destroy',$row->id)}}" method="post" class="d-inline">
                                        @csrf
